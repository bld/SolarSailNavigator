...
* TODO Toolbar to Show/Hide controls instead of in control module :FEATURE:WISHLIST:
...
* TODO Create "Frame" class to store info on reference frame e.g. name and name of Euler angles [1/4] :FEATURE:
...
** TODO GUIAngle instead of cone/clock/flatspin
...
* TODO Allow manually entering control numbers (angles/times) [2/3] :FEATURE:
** DONE Angles
** DONE Throttle
** TODO Times
* TODO Use multiple deltaV propellants					:BUG:
