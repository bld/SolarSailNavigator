...
* TODO Allow manually entering control numbers (angles/times) [1/3] :FEATURE:
** DONE Angles
** TODO Throttle
** TODO Times
...
* TODO Create "Frame" class to store info on reference frame e.g. name and name of Euler angles [0/4] :FEATURE:
...
* TODO ThrustPersistent should use engine's finalThrust to be correct 	:BUG:
