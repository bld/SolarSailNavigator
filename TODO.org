...
* TODO Create "Frame" class to store info on reference frame e.g. name and name of Euler angles [2/9] :FEATURE:
...
** TODO Persistent values in Navigator for generic "angles" instead of cone/clock/flatspin
** TODO Persistent values in Navigator for "frames"
** TODO Load & save to "angles" and "frames"
** TODO "Control" constructor should use "angles"
** TODO "Control" object should have "angles" instead of cone/clock/flatspin
...
* TODO Navigator default settings [0/1] 			    :FEATURE:
...
* TODO Use methods in PersistentEngine to calculate mass & deltaV   :FEATURE:
