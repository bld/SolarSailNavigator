...
* TODO Move PersistentThrust plugin into SolarSailNavigator [1/2]
** DONE Put source in sub-folder with KSPI license
** TODO Update Makefiles
* TODO Draw target line when target selected, even if preview not calculated
...
* TODO Add events when target selected to update targeting lines and information
* TODO Show mass consumption for flight profile
* TODO Warn when mass consumption exceeds remaining
* TODO Warn when future power usage of navigation plan exceeds vessel's generation ability
* TODO Toggle buttons to show [0/4]
** TODO Final orbit elements
** TODO Final orbit elements error with target
** TODO Final orbit
** TODO Preview
* DONE Draw trajectory segment when throttle is 0			:BUG:
* TODO In-track/cross-track/out-of-plane reference frame for ion engine :FEATURE:
